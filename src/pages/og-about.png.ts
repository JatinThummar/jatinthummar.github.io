...
export async function GET() {
	...
	const markup = rawHtml(`
		<div style="display:flex;width:100%;height:100%;background-color:${surface};">
			...
			<!-- Main left content -->
			<div style="display:flex;flex:1;flex-direction:column;justify-content:center;padding:56px;gap:48px;">

				<!-- Identity: avatar + name + title + handle -->
				<div style="display:flex;align-items:center;gap:36px;">
					<img src="${avatarBase64}" style="width:150px;height:150px;border-radius:24px;border:2px solid ${divider};" />
					<div style="display:flex;flex-direction:column;gap:6px;">
						<div style="display:flex;color:${emphasis};font-size:54px;font-weight:700;letter-spacing:-0.03em;line-height:1.05;">
							Jatin Thummar
						</div>
						<div style="display:flex;color:#60a5fa;font-size:30px;font-weight:700;letter-spacing:0.01em;">
							Frontend Engineer
						</div>
						<div style="display:flex;color:${muted};font-size:22px;font-weight:400;margin-top:2px;">
							@jatinthummarx
						</div>
					</div>
				</div>
